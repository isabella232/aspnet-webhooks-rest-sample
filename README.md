...
- [`Helpers/GraphHttpClient.cs`](https://github.com/microsoftgraph/aspnet-webhooks-rest-sample/blob/master/GraphWebhooks/Helpers/GraphHttpClient.cs) Http client wrapper implementation with retries on recommended transient errors codes from Graph Webhooks service. It also demonstrates the required infomration needed to be logged in the client code to contact Microsoft support.
